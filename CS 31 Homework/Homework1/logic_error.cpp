...
int main()
{
    ...
    double pctNewsom = 1000 * forNewsom / numberSurveyed; //This is a logic error, because program can run successfully, but the equation cannot satisfy the function we want to achieve
